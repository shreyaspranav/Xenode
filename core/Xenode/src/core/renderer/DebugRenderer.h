...
namespace Xen 
{
	...
	// DebugRenderer can be completely stripped from the build by not defining XEN_INCLUDE_DEBUG_RENDERER
	...
	public:
		...
		static void Draw2DBox(const Vec3& position, float rotation, const Vec2& scale, const Color& color, float thickness = 1.0f);
